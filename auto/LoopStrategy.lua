...
PriestDefaultStrategy = {
  ...
  PriestDynamicHeal("tank", 0.5, 5, nil, 1),
  -- Always heal a tank at <25%
  PriestDynamicHeal("tank", 0.25, nil, nil, 1),
  
  PowerWordShield("party", 0.15, 4),
  FlashHeal("party", 0.75, 3.5),
  PriestDynamicHeal("party", 0.85, 10, nil, 1),
  PriestDynamicHeal("party", 0.75, nil, nil, 1),
  OnlyNotCombat(
    PriestDynamicHeal("party", 0.90, nil, nil, 0)
  ),
